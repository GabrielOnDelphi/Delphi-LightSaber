program Tests_LightVcl.TranslatorLive;
...
uses
  ...
  LightCore.AppData,
  Test.LightVcl.TranslatorLive in 'Test.LightVcl.TranslatorLive.pas',
...
begin
  ...
  AppData:= TAppData.Create('LightVclTranslatorLiveTests');
  TRY
