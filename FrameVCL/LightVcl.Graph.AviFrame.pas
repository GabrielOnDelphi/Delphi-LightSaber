...
IMPLEMENTATION
USES
   LightCore, LightCore.Types, LightVcl.Common.SystemTime, LightVcl.Common.Clipboard, LightVcl.Common.Dialogs, LightCore.INIFile, LightVcl.Common.AppDataForm, LightVcl.Graph.Bitmap, LightVcl.Graph.Loader, LightCore.IO, LightCore.TextFile, LightVcl.Common.IO;
