...
USES
   ...
   LightVcl.Visual.StringGridBase, ccCore, LightVcl.Common.Dialogs;
...
USES LightVcl.Common.Colors, ccTextFile, ccMath, LightVcl.Common.SystemTime, LightVcl.Common.Clipboard;
