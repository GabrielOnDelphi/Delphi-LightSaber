...
USES
   ...
   ccINIFile, ccAppData; //, LightCom.AppData;
...
USES
   ccIO, ccTextFile, ccCore, {ccAppData,} LightCom.AppData; //{$IFDEF FRAMEWORK_FMX}LightFMX.lbAppData{$ELSE}LightCom.AppData,{$ENDIF};
 ...
 then
  begin
   { Non-resizable form?
    ...
    {Note: For strange reasons, for Vcl.Forms, LightCom.AppDataForm, I cannot read/write the ClientWidth (maybe because I call this routine from FormCreate?). I need to use Width. }
