...
USES
   LightVcl.Common.VclUtils, LightVcl.Common.Colors, LightVcl.Graph.Util, LightVcl.Common.Sound, LightVcl.Graph.Desktop, LightVcl.Visual.INIFile, LightCore.Core, LightVcl.Common.SystemTime, LightVcl.Common.Clipboard, LightVcl.Common.Dialogs, LightCore.INIFile, LightVcl.Common.AppDataForm, LightVcl.Common.PowerUtils, LightVcl.Common.ExecuteShell;
