...
USES
   LightCore.IO, LightCore.TextFile, LightCore, {LightCore.AppData,} LightVcl.Common.AppData; //{$IFDEF FRAMEWORK_FMX}LightFmx.Common.AppData{$ELSE}LightCom.AppData,{$ENDIF};
