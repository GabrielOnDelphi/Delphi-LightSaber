...
USES
  ...
  Vcl.Themes, Vcl.Controls, Vcl.Forms, LightCom.AppDataForm,Vcl.StdCtrls, Vcl.ExtCtrls;
...
USES
   LightCom.ExecuteShell, ccAppData, LightCom.AppData
, cvINIFile, LightCom.Translate, LightCom.IniFileQuick;
