...
IMPLEMENTATION
USES
   ccCore, LightVcl.Common.SystemTime, LightVcl.Common.Clipboard, LightVcl.Common.Dialogs, ccINIFile, LightVcl.Common.AppDataForm, LightVcl.Graph.Bitmap, LightVcl.Graph.Loader, ccIO, ccTextFile, LightVcl.Common.IO;
