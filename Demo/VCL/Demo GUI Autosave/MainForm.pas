...
USES
  ...
  LightVcl.Visual.RichEdit, Vcl.ComCtrls, LightCore, LightCore.Time, LightCore.Types, LightVcl.Common.SystemTime, LightVcl.Common.Clipboard, LightVcl.Common.Dialogs, LightCore.INIFile, LightVcl.Visual.AppDataForm,  Vcl.Dialogs, LightVcl.Visual.CheckBox, Vcl.ExtCtrls, LightVcl.Visual.RichLogTrack,
  System.Actions, Vcl.ActnList, Vcl.Menus, LightVcl.Visual.RadioButton, LightCore.AppData, LightVcl.Visual.AppData;
