...
TYPE
  TLightStream = class(TLightStream)
  private
  public
    { Padding }
...
function TLightStream.TryReadHeaderVersion(CONST Signature: AnsiString; OUT Version: Word): Boolean;
VAR
...
procedure TLightStream.ReadPaddingE(CONST Bytes: Integer);
VAR
  b: TBytes;
  CheckPointSize: Integer;
  i: Integer;
...
procedure TLightStream.ReadPadding;   // Def = default (default number of padding bytes is 100
begin
  ReadPaddingE(PaddingSize);
end;

procedure TLightStream.WritePadding;
begin
