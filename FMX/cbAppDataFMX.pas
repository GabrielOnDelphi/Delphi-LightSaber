...
{$IFDEF MACOS}
uses
  Posix.Stdlib, Posix.Unistd, System.IOUtils;

function TAppData.RunFileAtMacStartup(const FilePath: string; Active: Boolean): Boolean;
var
...
function TAppData.RunFileAtAndroidStartup(const FilePath: string; Active: Boolean): Boolean;
var
  Intent: JIntent;
...
function TAppData.RunFileAtLinuxStartup(const FilePath: string; Active: Boolean): Boolean;
var
