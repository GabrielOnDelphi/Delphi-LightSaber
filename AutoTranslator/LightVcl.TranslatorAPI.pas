...
CONST
  { Language code mappings - all DeepL supported languages
    See: https://developers.deepl.com/docs/resources/supported-languages }
  LanguageMappings: array[0..30] of TLanguageMap = (
    (Name: 'Arabic';      DeepLCode: 'AR'),
    ...
    (Name: 'Indonesian';  DeepLCode: 'ID'),
    (Name: 'Italian';     DeepLCode: 'IT'),
    (Name: 'Japanese';    DeepLCode: 'JA'),
    (Name: 'Korean';      DeepLCode: 'KO'),
    (Name: 'Latvian';     DeepLCode: 'LV'),
    (Name: 'Lithuanian';  DeepLCode: 'LT'),
    (Name: 'Norwegian';   DeepLCode: 'NB'),
    (Name: 'Polish';      DeepLCode: 'PL'),
    (Name: 'Portuguese';  DeepLCode: 'PT'),
    (Name: 'Romanian';    DeepLCode: 'RO'),
    (Name: 'Russian';     DeepLCode: 'RU'),
    (Name: 'Slovak';      DeepLCode: 'SK'),
    (Name: 'Slovenian';   DeepLCode: 'SL'),
    (Name: 'Spanish';     DeepLCode: 'ES'),
    (Name: 'Swedish';     DeepLCode: 'SV'),
    (Name: 'Turkish';     DeepLCode: 'TR'),
    (Name: 'Ukrainian';   DeepLCode: 'UK'),
    (Name: 'Vietnamese';  DeepLCode: 'VI')
  );
