...
VAR CacheSettings: TCubicIniFile;
begin
 TRY
 ...
 CacheSettings:= TCubicIniFile.Create(CacheFolder+ 'CacheSettings');
 with CacheSettings DO
  begin
   WriteInteger('Size' , 'ThumbWidth' , FThumbWidth);
   WriteInteger('Size' , 'ThumbHeight', FThumbHeight);
   WriteInteger('Index', 'LastEntry'  , FLastEntry);
  end;
...
begin
 ...
 with CacheSettings DO
  begin
   FThumbWidth := ReadInteger('Size' , 'ThumbWidth' , 128);
   FThumbHeight:= ReadInteger('Size' , 'ThumbHeight',  96);
   FLastEntry  := ReadInteger('Index', 'LastEntry'  ,   1);
  end;
 FreeAndNil(CacheSettings);
end;
