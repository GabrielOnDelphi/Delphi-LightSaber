...
USES
  Winapi.Messages, System.SysUtils, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.StdCtrls, Vcl.ExtCtrls, System.IOUtils,
...
begin
 ...
 StringToFile(GetFileName, s, woOverwrite, TRUE);
...
begin
 ...
 then
  begin
    StringToFile(GetFileName, mmoLangEditor.Text, woOverwrite, True); { Write with BOM in order to support Chinese lang }
    lblInfo.Caption := 'Saved as: '+ GetFileName;
    lblInfo.Visible:= TRUE;
    btnApplyEdits.Enabled:= TRUE;
  end
