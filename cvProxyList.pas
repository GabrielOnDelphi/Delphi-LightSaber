...
TYPE
  ...
  public
    ...
    procedure LoadSettings (CONST IniFile: TCubicIniFile);
    procedure SaveSettings (CONST IniFile: TCubicIniFile);
...
{--------------------------------------------------------------------------------------------------
   LOAD/SAVE SETTINGS
--------------------------------------------------------------------------------------------------}
procedure TProxyList.LoadSettings(CONST IniFile: TCubicIniFile);
begin
...
procedure TProxyList.SaveSettings(CONST IniFile: TCubicIniFile);
begin
