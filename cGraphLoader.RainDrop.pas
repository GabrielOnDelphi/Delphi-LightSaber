...
begin
 Clear;
 FileName:= aFileName;
 OrigImage:= cGraphLoader.LoadGraph(aFileName, TRUE, TRUE);
   ...
   case Version of
    ...
    1: begin
        ...
        TRY
          ...
          //JpgStream.SaveToFile(AppData.CurFolder+ '1.jpg');
