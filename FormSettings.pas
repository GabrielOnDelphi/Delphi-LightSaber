...
USES
  ...
  cvIniFile, ccCore, csSystem, cbDialogs, coolTrayIcon, cvPathEdit, cpProteus, cmDebugger, cvRadioButton, cvCheckBox, cpProteusIO, cvTrayIcon, FoldPanel;
...
USES
   FormSkinsDisk, cbAppData, csShell, FormMain;
