...
CONST HtmlFile= 'c:\MyProjects\BX\SourceCode\Tester StripWebPage\tester ciHtmlImg\2.html';
VAR
   Tags: TStringList;
...
instead of this, use: ciInternet.ExtractAttribValue
...
begin
 raise exception.Create('extractLinkedImges function is obsolete. Use ciHtmlImg.ExtractImagesFromAHREF instead.');
